...
class TestElandCriteriaBuilder(TestCase):
    ...
    def test_get_criteria_key_success_get_case1(self):
        ...
        self.assertEqual(builder.get_criteria_value("gender_tag", 'female'), Gender.FEMALE)
